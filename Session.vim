...
map  :py3file /usr/share/vim/addons/syntax/clang-format.py
nnoremap , :
nnoremap < w  
...
imap  :py3file /usr/share/vim/addons/syntax/clang-format.py
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 109 + 119) / 238)
exe 'vert 2resize ' . ((&columns * 128 + 119) / 238)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("src/bmi-cli.c") | buffer src/bmi-cli.c | else | edit src/bmi-cli.c | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
